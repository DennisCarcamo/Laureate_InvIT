...
var DashboardService = /** @class */ (function () {
    ...
    DashboardService.prototype.loadInitialDashboard = function () {
        return this.httpClient.get("http://172.20.33.32/api/v1/dashboard").map(function (result) { return result; });
    };
    DashboardService.prototype.inStoreModels = function (type, state) {
        return this.httpClient.get("http://172.20.33.32/api/v1/dashboarddetail/" + type + "/" + state).map(function (result) { return result; });
    };
