...
var DashboardService = /** @class */ (function () {
    ...
    DashboardService.prototype.searchLifetime = function () {
        ...
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]()
            .set('Authorization', x);
        return this.httpClient.get("http://172.20.33.32/api/v1/dashboardlifetime", { headers: headers }).map(function (result) { return result; });
    };
    DashboardService.prototype.searchLifetimeDetail = function (less, number, state, page) {
        return this.httpClient.get("http://172.20.33.32/api/v1/dashboardlifetimedetail?less=" + less + "&number=" + number + "&state=" + state + "&page=" + page).map(function (result) { return result; });
    };
    DashboardService.prototype.searchItemLifetimeDetail = function (page, text) {
        return this.httpClient.get("http://172.20.33.32/api/v1/dashboardsearchlifetimedetail?text=" + text + "&page=" + page).map(function (result) { return result; });
    };
